...
public class ModItems {
    ...
    public static final Item REINFORCED_BOW = registerItem("reinforced_bow", new Item(new Item.Settings().maxDamage(500)));
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(fabricItemGroupEntries -> {
            ...
            ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register(fabricItemGroupEntries1 -> {
                fabricItemGroupEntries.add(REINFORCED_BOW);
            });
